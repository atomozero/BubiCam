...
// StopCaptureKeepNode removed - the system notifications during resolution
// changes are generated by Haiku's USB stack when the driver resets the
// alternate setting, not by BubiCam's Media Kit operations. The normal
// StopCapture/StartCapture flow is used with fChangingResolution flag
// in MainWindow to suppress BubiCam's own reactions to the events.
